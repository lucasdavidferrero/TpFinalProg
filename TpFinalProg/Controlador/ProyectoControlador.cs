...
namespace TpFinalProg.Controlador {
    internal class ProyectoControlador {
         ...
         public static int crear(string nombre, float montoEstimado, int tiempoEstimado, int idPropietario, int legajo) {
        ...
        public static void actualizar(int id_proyecto, string nombre, float montoEstimado, int tiempoEstimado, int idPropietario, int legajo) {
